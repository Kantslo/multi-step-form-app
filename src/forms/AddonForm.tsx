    ...
    <>
      <section className="flex flex-col justify-center font-ubuntu bg-white px-6 py-8 max-w-[343px] rounded-[10px] mx-auto mb-6">
        ...
        <form className="flex flex-col gap-y-3 mt-[22px]">
          <label style={{  }} className="flex flex-row items-center justify-between border border-[#D6D9E6] rounded-[8px] px-4 py-3" htmlFor="online_service">
            <div className="flex flex-row gap-x-4">
              <input id="online_service" name="online_service" type="checkbox" />
              <div className="flex flex-col">
          ...
          <label style={{  }} className="flex flex-row items-center justify-between border border-[#D6D9E6] rounded-[8px] px-4 py-3" htmlFor="larger_storage">
            <div className="flex flex-row gap-x-4">
              <input id="larger_storage" name="larger_storage" type="checkbox" />
              <div className="flex flex-col">
          ...
          <label style={{  }} className="flex flex-row items-center justify-between border border-[#D6D9E6] rounded-[8px] px-4 py-3" htmlFor="customizable_profile">
            <div className="flex flex-row gap-x-4">
              <input id="customizable_profile" name="customizable_profile" type="checkbox" />
              <div className="flex flex-col">
